...
import { automaatPrijzen } from '../components/data'
...
const Automaat = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Rijschool Profdrive - Tarieven-automaat</title>
        <meta
          name='description'
          content='Rijschool Profdrive - Tarieven-automaat'
        />
        <meta charset='utf-8' />
        <meta name='viewport' content='width=device-width, initial-scale=1' />
      </Helmet>
      <div className='pt-32 mb-2 flex items-center justify-center'>
        <h1 className='text-4xl '>Tarieven automaat</h1>
      </div>
      <div className='mx-auto grid max-w-7xl lg:grid-cols-3 gap-12 mt-8  lg:gap-8 pt-12 pb-12 px-4 sm:px-6 lg:px-8'>
        {automaatPrijzen.map((plan) => (
          <div
